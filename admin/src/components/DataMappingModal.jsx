...
const DataMappingModal = ({ isOpen, onClose, connection, onSave }) => {
  ...
  const standardFields = {
    ...
    products: [
      ...
      { key: 'salida', label: 'Fecha de Salida (fuente)', required: false, type: 'date' },
      { key: 'regreso', label: 'Fecha de Regreso (fuente)', required: false, type: 'date' },
      { key: 'fecha_salida', label: 'Fecha de Salida', required: false, type: 'date' },
      { key: 'fecha_regreso', label: 'Fecha de Regreso', required: false, type: 'date' },
      ...
      { key: 'checkedbag', label: 'Checked bag', required: false, type: 'boolean' },
      { key: 'inf_fare', label: 'Tarifa Infante', required: false, type: 'number' },
    ],
