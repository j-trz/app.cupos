...
function SectionHeader({ icon: Icon, title, badge }) {
  return (
    <div className="flex items-center gap-3 mb-5">
      {Icon && <span className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800">
        <Icon className="w-5 h-5 text-blue-600 dark:text-blue-400" />
      </span>}
      <div>
        <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">{title}</h2>
        {badge && <span className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 px-2 py-0.5 rounded-full font-medium">{badge}</span>}
      </div>
=======
...
>>>>>>> cde956dd2f341b207cc2a4666732846580682b44
    </div>
  );
}
