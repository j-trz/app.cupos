...
export default function AIChatTopbar({ onOpenSessions }) {
    ...
    return (
        <header className="shrink-0 flex items-center justify-between px-4 py-3 border-b border-zinc-200 bg-white">
            <div className="flex items-center gap-2.5">
                ...
                {onOpenSessions && (
                    <button
                        ...
                        className="md:hidden -ml-1 flex items-center justify-center h-8 w-8 rounded-lg text-zinc-600 hover:bg-zinc-100"
                ...
                <h1 className="text-sm font-semibold text-zinc-900">Asistente IA</h1>
            </div>
