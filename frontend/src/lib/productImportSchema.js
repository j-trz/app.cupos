...
export const PRODUCT_IMPORT_COLUMNS = [
  ...
  { key: 'precio', type: 'number', required: false, min: 0, hint: 'Venta ADT ya calculada — si se deja vacío pero se completa tarifa_adt, se recalcula sola' },
  { key: 'tarifa_adt', type: 'number', required: false, min: 0 },
  { key: 'impuestos_adt', type: 'number', required: false, min: 0 },
  { key: 'neto_1', type: 'number', required: false, min: 0 },
  { key: 'op', type: 'number', required: false, min: 0, hint: 'Legacy: si se completa y op_adt/op_chd/op_inf se dejan vacíos, se replica a los 3 tipos' },
  { key: 'op_adt', type: 'number', required: false, min: 0 },
  { key: 'op_chd', type: 'number', required: false, min: 0 },
  { key: 'op_inf', type: 'number', required: false, min: 0 },
  ...
  { key: 'inf_fare', type: 'number', required: false, min: 0, hint: 'Venta INF ya calculada — si se deja vacío pero se completa tarifa_inf, se recalcula sola' },
  { key: 'tarifa_inf', type: 'number', required: false, min: 0 },
  { key: 'impuestos_inf', type: 'number', required: false, min: 0 },
  { key: 'chd_fare', type: 'number', required: false, min: 0, hint: 'Venta CHD ya calculada — si se deja vacío pero se completa tarifa_chd, se recalcula sola' },
  { key: 'tarifa_chd', type: 'number', required: false, min: 0 },
  { key: 'impuestos_chd', type: 'number', required: false, min: 0 },
];
