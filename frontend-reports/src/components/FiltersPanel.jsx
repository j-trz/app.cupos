...
>>>>>>> main
  ...
  // Sobrescribir valores de Temporada si temporadasValidas está presente
  ...
  // Campos a excluir en el panel de filtros
  // Solo mostrar estos filtros activos
  // Asegurar que Aerolinea esté primero
  const allowed = [
    'Proveedor',
    'Tipo de servicio', 'Tipo Servicio', 'Tipo de operación', 'Destino', 'Compañia', 'Salida', 'Regreso', 'Temporada'
  ]; // Quitado 'Agencia'

  // Selector múltiple para comparar temporadas
  // (eliminado: temporadaField sin uso)
  // Valor por defecto para tipo de servicio
  React.useEffect(() => {
  ...
  // Filtros multiselección: Temporada, Tipo de servicio, Tipo Servicio, Tipo de producto, Producto
  ...
  <div className="flex flex-col gap-2 mb-3">
                  ...
                  {tooltipText && (
                    <Tooltip
                      ...
                      style={{
                        ...
                        padding: '6px 10px',
                        zIndex: 2147483647, // Máximo z-index para asegurar que quede por encima de todo
                        pointerEvents: 'auto'
                      }}
      ...
      <div className="flex justify-end mb-3">
        <button
          className="px-4 py-1.5 bg-[#2563eb] text-white rounded-full shadow-md hover:bg-[#304D85] transition font-semibold text-sm flex items-center gap-2"
