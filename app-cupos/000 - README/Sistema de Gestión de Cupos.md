...
El catálogo completo de notas por carpeta, y la convención para agregar una nota nueva, viven en [[index]] (raíz del vault) — arrancar ahí, no acá, para orientarse en una sesión nueva. Historial cronológico de altas/consultas/lints en [[log]]. Sello de frescura y protocolo de actualización en [[Gotchas y Reglas de Oro]] (sección final).