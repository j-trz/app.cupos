...
> Última verificación contra `user_handler.go` (Login/JWT) y `order_handler.go` (CreateHold/CreateReservation) — 2026-08-10. Sin cambios: la guía sigue siendo exacta.
